...
export const navBar = () => {
  return (
    <div className="font-serif">
     <div className=" h-[400px] bg-cover bg-center bg-[url('/bgg.png')] text-white">
             <h1 className="text-center font-bold !text-[50px] p-4 text-black">
               Hey! Welcome to my portfolio
             </h1>
             <p className="p-5 text-[25px] text-center font-semibold text-black">
